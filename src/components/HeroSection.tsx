        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-8">
          ...
          >
            <div className="relative">
              <motion.div 
                className="w-56 h-56 md:w-72 md:h-72 lg:w-80 lg:h-80 rounded-full overflow-hidden border-4 border-accent/20 glow-accent"
              ...
              {/* Decorative ring */}
              <motion.div 
                className="absolute inset-0 rounded-full border-2 border-accent/30 scale-110"
                animate={{ 
                  scale: [1.1, 1.15, 1.1],
                  opacity: [0.3, 0.6, 0.3]
                }}
